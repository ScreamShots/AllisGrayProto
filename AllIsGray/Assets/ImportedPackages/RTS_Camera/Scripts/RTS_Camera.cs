...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void HeightCalculation()
        {
            ...
            float difference = 0;
            float targetAngle = Mathf.Lerp(minAngle, maxAngle, zoomPos);
            ...
            {
                m_Transform.Rotate(Vector3.right, angleDifference, Space.Self);
        ...
        private void Rotation()
        {
            if(useKeyboardRotation)
                m_Transform.Rotate(Vector3.up, RotationDirection * Time.deltaTime * rotationSped, Space.World);
